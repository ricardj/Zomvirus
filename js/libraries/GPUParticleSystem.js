...
THREE.GPUParticleSystem = function ( options ) {
	...
	this.particleNoiseTex = this.PARTICLE_NOISE_TEXTURE || textureLoader.load( 'assets/images/particle.png' );
	this.particleNoiseTex.wrapS = this.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load( 'assets/images/particle.png' );
...
THREE.GPUParticleContainer = function ( maxParticles, particleSystem ) {
	...
	this.spawnParticle = function ( options ) {
		...
		positionStartAttribute.array[ i * 3 + 0 ] = 0;//position.x + ( particleSystem.random() * positionRandomness );
		positionStartAttribute.array[ i * 3 + 1 ] = 0;//position.y + ( particleSystem.random() * positionRandomness );
		positionStartAttribute.array[ i * 3 + 2 ] = 0;//position.z + ( particleSystem.random() * positionRandomness );
0;//
		if ( smoothPosition === true ) {

			positionStartAttribute.array[ i * 3 + 0 ] += 0;//- ( velocity.x * particleSystem.random() );
			positionStartAttribute.array[ i * 3 + 1 ] += 0;//- ( velocity.y * particleSystem.random() );
			positionStartAttribute.array[ i * 3 + 2 ] += 0;//- ( velocity.z * particleSystem.random() );
